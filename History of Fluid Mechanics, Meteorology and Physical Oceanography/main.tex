...
Hadley provided the first convincing physical explanation of the trade winds. In his 1735 paper, he argued that strong solar heating near the equator causes warm air to rise and flow poleward at high altitude, while cooler air returns toward the equator near the surface. He recognised that Earth's rotation deflects these large-scale air currents, explaining why the trade winds do not blow directly north--south.

This circulation is now known as the Hadley circulation and forms one of the three major large-scale meridional circulation cells of the atmosphere. Hadley's work was an important early step toward understanding the atmosphere as a rotating fluid whose circulation is controlled by both thermal forcing and planetary rotation.
...
{}Ludwig Prandtl was a German physicist and engineer who developed boundary-layer theory and pioneered modern approaches to turbulence modelling.
...
Taylor made fundamental contributions to the statistical theory of turbulence. He studied velocity fluctuations and their correlations in turbulent flows, showing that turbulence could be described using statistical quantities rather than by tracking individual eddies. He introduced characteristic scales such as the Taylor microscale and developed theories of turbulent diffusion and mixing.

Taylor also proposed Taylor's frozen-turbulence hypothesis, which assumes that turbulent structures are carried past a fixed observer by the mean flow much faster than they change internally. This allows spatial variations in turbulence to be related to measurements made over time and became widely used in atmospheric and laboratory measurements.

His work also connected fluid mechanics with oceanography and meteorology. During the Second World War, he studied blast waves and underwater explosions, applying dimensional analysis to estimate the behaviour and energy of large explosions. His broad work helped establish modern statistical approaches to turbulence and transport.
